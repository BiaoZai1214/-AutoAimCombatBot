...
void MX_GPIO_UserInit(void)
{
  ...
  GPIO_InitStruct.Pin = M4_IN1_Pin;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);
  GPIO_InitStruct.Pin = M4_IN2_Pin;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /* LCD 背光 (PH6) 和数据/命令 (PJ11) */
  ...
  /* 初始电平 */
  HAL_GPIO_WritePin(GPIOD, M1_IN1_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOI, M1_IN2_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOG, M2_IN1_Pin | M2_IN2_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOB, M3_IN1_Pin | M3_IN2_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOH, M4_IN1_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOC, M4_IN2_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(STBY_GPIO_Port, STBY_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOH, GPIO_PIN_6, GPIO_PIN_SET);   /* LCD 背光开 */
}
/* USER CODE END 0 */
